namespace :shared do
	...
	task :make_symlinks do
		...
		run "for p in `find -L #{release_path} -type l`; do t=`readlink $p | grep -o 'shared/.*$'`; sudo mkdir -p #{release_path}/$t; sudo chown ssh cewolfe@otbinteractive.com #{release_path}/$t; done"
	end
end
